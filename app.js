...
(function () {
  ...
  function recompute() {
    ...
    $('surfaceDeterminante').placeholder = (Math.max(0, sc - sa)) + ' (auto)';
    $('abattementVal').textContent = pct(parseFloat(val('abattementServitudes')) || 0, 0);
    $('nbNiveauxVal').textContent = val('nbNiveaux');
